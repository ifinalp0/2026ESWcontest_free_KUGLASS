...
// DANGEROUS TEST BUILD ONLY: keep the raw MCU ENABLE_CH0..CH3 GPIO outputs
// HIGH after GPIO initialization, including PWM blanking and fault/watchdog
// safe-off paths. Never connect a Power Stage or high voltage with this set.
static constexpr bool KUGLASS_ENABLE_OUTPUT_ALWAYS_HIGH = true;
...
static_assert(KUGLASS_STANDALONE_OUTPUT_TEST ||
                  !KUGLASS_ENABLE_OUTPUT_ALWAYS_HIGH,
              "Always-HIGH ENABLE is permitted only in standalone test mode.");
