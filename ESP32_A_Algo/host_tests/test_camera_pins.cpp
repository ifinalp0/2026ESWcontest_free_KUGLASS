...
int main() {
    ...
    static_assert(camera_pins::assigned_pins_are_valid());
    ...
    static_assert(camera_pins::is_devkit_reserved_pin(43));
    ...
    static_assert(camera_pins::is_available_control_pin(39));
    static_assert(camera_pins::is_available_control_pin(40));
    static_assert(camera_pins::is_available_control_pin(41));
    static_assert(!camera_pins::is_valid_esp32s3_gpio(25));
    static_assert(!camera_pins::is_valid_esp32s3_gpio(49));
    return 0;
}
